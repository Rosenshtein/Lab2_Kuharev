...
namespace Lab2
{
    public class MenuFunc
    {
        ...
        {
            protected static bool arrayIsLoad = false;
            ...
            public static void PrintArray(int[] array, string desk = "")
            {
                ...
                if (desk != "") { Console.Write($"({desk})", desk); }
                Console.WriteLine();
            }
            ...
            public static bool ChoiceOfSLFile(int type)
            {

                string text = "";

                if (type == 1) { text = "Сохранить в файл?"; }
                else if (type == 0) { text = "Загрузить из файла?"; }
